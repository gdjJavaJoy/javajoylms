				...
				<div class="container px-6 mx-auto grid">
					...
					<div class="w-full overflow-hidden rounded-lg shadow-xs">
						<div class="w-full overflow-x-auto">
							<form method="post"
								action="${pageContext.request.contextPath}/addFreeBoard"
								...
								<table class="w-full whitespace-no-wrap">
									<tr class="text-gray-700 dark:text-gray-400">
										...
										<td class="px-4 py-3"><input
											...
											placeholder="제목입력" name="boardTitle" id="boardTitle" /> <input
											type="text" name="memberId" value="${loginUser}"
											hidden="hidden"></td>
									</tr>
									<tr class="text-gray-700 dark:text-gray-400">
										<td class="px-4 py-3 text-sm">내용</td>
										<td class="px-4 py-3"><textarea
												class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
												rows="3" placeholder="내용을 입력해주세요" name="boardContent"
												id="boardContent"></textarea></td>
									</tr>
									<tr class="text-gray-700 dark:text-gray-400">
										<td class="px-4 py-3 text-sm">익명설정</td>
										<td class="px-4 py-3"><input type="radio"
											class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
											name="privateNo" value="1" checked="checked" /> 익명X <input
											type="radio"
											class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
											name="privateNo" value="2" /> 익명O</td>
									</tr>
									<tr>
										<td class="px-4 py-3 text-sm">
											<button
												class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
												id="addFileUpload" type="button">파일업로드 추가</button>
										</td>
										<td class="px-4 py-3">
							...
							<div>
								<button
									class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
									id="addFreeBoardBtn" type="button">글작성</button>
							</div>
						</div>
					</div>
				</div>
