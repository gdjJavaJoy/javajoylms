						...
						<div class="w-full overflow-x-auto">
							<form method="post" action="${pageContext.request.contextPath}/addFreeBoard" id="form" enctype="multipart/form-data">
									...
									<tr class="text-gray-700 dark:text-gray-400">
										...
										<td class="px-4 py-3">
										 <input
											...
											name="privateNo"
											value="2"
											<c:if test="${board.privateNo eq 2}">checked</c:if>
											/>
											익명O
										</td>
									</tr>
								...
								<c:forEach var="bf" items="${boardFile}">
											...
											<a href="${pageContext.request.contextPath}/removeFreeBoardFileByBoardFileNo?boardFileNo=${bf.boardFileNo}&boardNo=${board.boardNo}">삭제</a>
								</c:forEach>
								</c:if>
								</form>
									<br>
