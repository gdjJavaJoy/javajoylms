...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
 <head>
    ...
    <title>Admin Modify Notice Page</title>
    	<style>
        ...
        <main class="h-full pb-16 overflow-y-auto">
            ...
            <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
              ...
              <div class="flex items-center">
                ...
                <span>Modify Notice Page</span>
              </div>
              <span>${totalCount-((currentPage-1)*rowPerPage)}번 상세보기 &RightArrow;</span>
            </a>
            </c:forEach>
                        ...
                        <div class="flex items-center text-sm">
                          ...
                          <div>
					    		<c:forEach var="boardfile" items="${boardfile}">
									<div>
										${boardfile.boardFileOriginalName} 
										...
										href="${pageContext.request.contextPath}/removeNoticefile?boardFileNo=${boardfile.boardFileNo}&boardNo=${boardfile.boardNo}">삭제</a>
									</div>
								</c:forEach>
                          </div>
                        </div>
                 ...
                 <br>
                 	<div style="display:inline;">
	                 	<div style="float:inherit;" display:inline-block;"></div>
			                  ...
			                  type="button" id="modifyNotice">공지사항 수정
			                 </button>
		            </div>
	               </form>
	               </div>
