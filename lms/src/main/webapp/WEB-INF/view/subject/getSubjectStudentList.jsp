			...
			<main class="h-full pb-16 overflow-y-auto">
				<div class="container grid px-6 mx-auto">
					...
					<a
						...
						href="${pageContext.request.contextPath}/addSubjectStudent">
                  ...
                  <path
					...
					<!-- With avatar -->
					<h4
						class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">${subjectNo}
						학생 목록</h4>
					<a
						href="${pageContext.request.contextPath}/getSubjectStudentList?subjectNo=${subjectNo}">초기화</a>
						...
						function reply_click(clicked_id)
							{
								 alert(clicked_id);
										...
										<tr class="text-gray-700 dark:text-gray-400" align="center">
											...
											<td><a class="grid px-4 py-3 text-sm"
													href="${pageContext.request.contextPath}/removeSubjectStudent?subjectNo=${subjectNo}&memberId=${s.memberId}">삭제</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
