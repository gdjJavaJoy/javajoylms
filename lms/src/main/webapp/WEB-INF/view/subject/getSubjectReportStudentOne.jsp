      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <!-- With avatar -->
           		<h4 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">학생 과제 상세보기
           		</h4> 
           	</c:forEach>
            <!-- 과제 상세보기 테이블 -->
              	 ...
              	 <c:forEach var="subjectReportStudent" items="${subjectReportStudent}">
               		<table class="w-full whitespace-no-wrap">
	                    <tr class="text-sm font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
	                    	<th class="px-4 py-3">과제 제출 날짜</th>
	                    ...
	                    <tr class="text-sm font-semibold tracking-wide text-left text-gray-500 border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
	                    	...
	                    	<td class="px-4 py-3 text-sm">
	                    		<textarea class="text-gray-700 dark:text-gray-400" readonly>${subjectReportStudent.subjectReportStudentContent}</textarea>
	                    	</td>
	                    </tr>
	                     <tr class="text-sm font-semibold tracking-wide text-left text-gray-500 border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
	                    	<th class="px-4 py-3">과제 점수</th>
	                    	<c:if test="${subjectReportStudent.score eq 0}">
	                    		<td class="px-4 py-3 text-sm">0(채점 전)</td>
							</c:if>
