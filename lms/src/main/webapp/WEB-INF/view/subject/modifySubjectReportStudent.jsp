 ...
 <head>
	...
	<script>
		$(document).ready(function(){
			...
			$('#modifySubjectReportStudent').click(function(){
				if($('#subjectReportNo').val() == '') {
					...
					if(flag) {
						$('#modifySubjectReportStudentForm').submit();
					} else {
						Swal.fire('파일 첨부를 다시 확인하십시오');
					}
				}
	...
	<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            ...
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">${loginUser}님의 과제 채점</h2>
            <!-- CTA -->
            ...
            <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
              ...
              <span> ${subjectReportStudent.subjectReportNo}번 과제 제출 현황 &RightArrow;</span>
            </a>
            </c:forEach>
            ...
            <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
             	<form id="modifySubjectReportStudentForm" method="post" name="modifySubjectReportStudentForm" action="${pageContext.request.contextPath}/modifySubjectReportStudent" enctype="multipart/form-data">
             	<c:forEach var="subjectReportStudent" items="${subjectReportStudent}">
	                	<table class="w-full whitespace-no-wrap">
	                		<input type="hidden" id="subjectReportNo" name="subjectReportNo" class="form-control" value="${subjectReportStudent.subjectReportNo}">   
	                		<input type="hidden" id="subjectReportStudentNo" name="subjectReportStudentNo" class="form-control" value="${subjectReportStudent.subjectReportStudentNo}">   
	                		<input type="hidden" id="subjectReportStudentContent" name="subjectReportStudentContent" class="form-control" value="${subjectReportStudent.subjectReportStudentContent}">   
		                        ...
		                        <div class="flex items-center text-sm">
		                          ...
		                          <div>
				    		 	  	<p class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
			                            	<input type="text" id="memberId" name="memberId" value="${subjectReportStudent.memberId}" readonly>
			                        </p>
		                          </div>
		                        </div>
		                      </td>
			                 ...
			                 <tr class="text-gray-700 dark:text-gray-400">
			                      ...
			                      <td class="px-4 py-3">
			                        <div class="flex items-center text-sm">
			                          ...
			                          <div>
			                            <p class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
			                            	<input type="text" id="subjectReportStudentTitle" name="subjectReportStudentTitle" value="${subjectReportStudent.subjectReportStudentTitle}" readonly>
			                            </p>
			                          </div>
			                        </div>
			                      </td>
			                 ...
			                 <tr class="text-gray-700 dark:text-gray-400">
			                      ...
			                      <td class="px-4 py-3">
			                        <div class="flex items-center text-sm">
			                          ...
			                          <div>
			                            <p class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
			                            	<input type="number" id="score" name="score" value="${subjectReportStudent.score}">
			                            </p>
			                          </div>
			                        </div>
			                      </td>
                 ...
                 <br>
                 	<div style="display:inline;">
	                 	<div style="float:inherit;" display:inline-block;"></div>
			                  ...
			                  type="button" id="modifySubjectReportStudent">과제 수정
			                 </button>
		            </div>
	               </form>
	               </div>
