...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
 <head>
	...
	$(document).ready(function() {
		...
		if(flag) {
			$('#fileSection').append("<div><input class='boardfileList' onchange='checkFile(this)' type='file' name='subjectNoticefileList' accept='image/*, .xls, .xlsx, pdf, hwp, docx, ppt, txt'></div>");
		} else {
