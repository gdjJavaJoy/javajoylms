...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Subject Notice List Page</title>
    <link
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">${subjectNo}번 강좌의 Subject Notice List Page</h2>
            <!-- CTA -->
            ...
            <!-- With avatar -->
	            	...
	            	<c:if test="${level eq 2}">
	            		<a href="${pageContext.request.contextPath}/addSubjectNotice?subjectNo=${s.subjectNo}" class="text-sm" style="float: right;">강좌 공지사항 추가</a>
	       			</c:if>
	       			</c:forEach>
	            </h4>
