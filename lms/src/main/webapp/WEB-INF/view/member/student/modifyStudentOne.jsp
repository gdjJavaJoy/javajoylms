                  ...
                  <path fill-rule="evenodd"
						...
						<template x-if="isPagesMenuOpen">
							<ul x-transition:enter="transition-all ease-in-out duration-300"
								...
								<li
									class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
									<a class="w-full" href="pages/404.html">비밀번호변경</a>
								</li>
								<li
									class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
					...
					<div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
						<div class="w-full overflow-x-auto">
							<form action="#" method="post">
										...
										<td class="px-4 py-3">
											<div class="flex items-center text-sm">
												...
												<select
													...
													name="gener" id="gender">
													<option value="${student.studentGender}">현재 저장된 성별 : ${student.studentGender}</option>
										...
										<td class="px-4 py-3">
											<div class="flex items-center text-sm">
												...
												<select
													...
													<option value="${student.studentEducation}">현재 저장된 학력 : ${student.studentEducation}</option>
								...
								<button type="button"
									class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">회원정보
									수정</button>
							</form>
						</div>
					</div>
