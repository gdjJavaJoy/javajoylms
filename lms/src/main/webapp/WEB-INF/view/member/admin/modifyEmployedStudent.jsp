...
<title>modifyEmployedStudent</title>
                  ...
                  <path
					...
					<div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
						<div class="w-full overflow-x-auto">
							<form id="modifyEmployStudentForm" method="post"
								action="${pageContext.request.contextPath}/modifyEmployedStudent">
												...
												<div>
													<p class="font-semibold">
														<input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
															type="text" id="memberId"  readonly="readonly"
															name="memberId" value="${studentJob.memberId}">
													</p>
												</div>
											</div>
										</td>
												...
												<div>
													<p class="font-semibold">
														<input
															...
															name="company" value="${studentJob.company}">
													</p>
												</div>
											</div>
										</td>
												...
												<div>
													<p class="font-semibold">
														<input
															...
															name="startSalary" value="${studentJob.startSalary}">
													</p>
												</div>
											</div>
										</td>
...
<script>
	$('#modifyBtn').click(function() {
		if ($('#memberId').val() == '') {
			...
			$('#modifyEmployStudentForm').submit();
		}
	});
</script>
</html>
